...
<!--Em um framework atual, que oferece essa interface de forma simples, o repositório pdoeria passar a chamada ao framework, se a configuração não passar pelo repositório. 
